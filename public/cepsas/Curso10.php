	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso10.php">Cooperativismo</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/10 Cooperativismo.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=rfxO51Jw6OU" target="_blank">Cooperativismo como una alternativa.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=p1TQ27mxk7Y" target="_blank">Los Valores Cooperativos.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=O2fsE2WU8v0" target="_blank">Los Principios Cooperativos.</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 10)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso10_prueba.php'><strong>Presentar prueba del curso</strong></a>
