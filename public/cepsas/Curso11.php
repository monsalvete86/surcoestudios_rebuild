...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 11</title>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso9.php">Espacios confinados</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/11. Espacios Confinados.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=wPSogAbLmFY" target="_blank">Espacios confinados</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=7fuKIhDVrZc" target="_blank">Ingreso a espacios confinados</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 11)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curs11_prueba.php'><strong>Presentar prueba del curso</strong></a>
						<span> (Ultimo resultado: ".$consulta2['resultado']." % <b>$MsjResult!!!<b>)</span>";
					}
					else
					{
						echo "<a href='Curso11_prueba.php'><strong>Presentar prueba del curso</strong></a>";
					}
				}
				else
				{
