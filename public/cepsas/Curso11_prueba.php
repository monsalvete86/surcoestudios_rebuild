		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 11 : ESPACIOS CONFINADOS - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">1.	Un espacio, que tiene medios limitados para entrar y salir, es decir no permiten una entrada ni una 
							salida en forma segura y r&aacute;pida de todos sus ocupantes ¿se llama?</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>Espacio abierto</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>Espacio cerrado</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="b"&&$r1!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td><td>Espacio confinado</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="c"&&$r1!="0"){ echo "checked"; }?> value="c"></td>
						</tr>
						<tr>
							<td><b>d.</b></td><td>Espacio inherente</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="c"&&$r1!="0"){ echo "checked"; }?> value="d"></td>
						</tr>
						
						<tr>
							<td rowspan="5"><b>2.</b></td>
							<td colspan="3">2.	Aquél espacio confinado en el que no existe riesgo por deficiencia o enriquecimiento de ox&iacute;geno, 
							ni atm&oacute;sferas explosivas o inflamables, y en el que las concentraciones de sustancias qu&iacute;micas peligrosas 
							son inferiores al nivel de acci&oacute;n. ¿se le llama?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Espacio confinado Tipo I</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="a"&&$r2!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td>
							<td>Espacio confinado Tipo II</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="b"&&$r2!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td>
							<td>Espacio confinado Tipo III</td>
						...
						<tr>
							...
							<td colspan="3">Aquel espacio confinado que tiene el potencial de causar lesiones y/o enfermedades de trabajo, 
							e incluso puede ser inmediatamente peligroso para la vida y la salud. ¿se llama?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Espacio confinado Tipo I</td>
						...
						<tr>
							...
							<td colspan="4">Es una actividad previa, notificar oportunamente a todas las secciones de la empresa que puedan resultar 
							afectadas por el trabajo en espacio confinado</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">5.	El trabajo en espacios confinados exige la implementaci&oacute;n de un sistema 
							personal de interrupci&oacute;n de ca&iacute;das</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">6.	Punto de conexión segura para los cabos de salvamento, acolladores o dispositivos
							de desaceleraci&oacute;n, independiente de los medios utilizados para apoyar o suspender al trabajador, 
							se llama dispositivo de desaceleraci&oacute;n.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">7.	Al punto de conexi&oacute;n segura para los cabos de salvamento, acolladores o dispositivos
							de desaceleraci&oacute;n, independiente de los medios utilizados para apoyar o suspender al trabajador, se llama anclaje.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">8.	El uso de cintur&oacute;n corporal est&aacute; prohibido (OSHA - 1 de enero/98). Un arn&eacute;s ofrece mejor
							protección de ca&iacute;da libre, reduce el riesgo de lesiones y distribuye las fuerzas de interrupci&oacute;n
							de ca&iacute;da a lo largo de los muslos, la pelvis, la cintura, el pecho y los hombros.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">9.	El supervisor, observa las condiciones en que se realiza el trabajo, lleva la lista 
							de los entrantes y reporta si alguien no autorizado entra.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">10.	El asistente, Verifica que las condiciones de entrada sean seguras, que el trabajador 
							entrante presente el permiso y las condiciones consignadas en &eacute;ste se cumplan.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso11.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
