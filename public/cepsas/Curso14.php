	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso14.php">Brigadistas (Contra Incendios)</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/14 Brigadistas ( Contra Incendios).pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				...
				<div style="left: 61px; position: relative">
    				...
    				<div style="left: 61px; position: relative">
    					<a target="_blank" href="https://www.youtube.com/watch?v=04HXbTN6gMs" target="_blank">Prevención de Incendios y Uso de Extintores de Portátiles</a>
    				</div>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 14)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso14_prueba.php'><strong>Presentar prueba del curso</strong></a>
