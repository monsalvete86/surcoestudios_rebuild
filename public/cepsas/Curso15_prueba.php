...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 15</title>
		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 15 : RESCATISTA EN ALTURAS - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">Qué es retención?</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>Es un sistema que permite delimitar un sistema de trabajo que impide que el trabajador entre en una zona con riesgo de caída. Este dispositivo no está destinado a detener</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>Sistema, como su propio nombre indica, sujeta  al usuario y le permite posicionarse con precisión en apoyo o en suspensión</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="b"&&$r1!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td><td>Se debe prever un plan de evacuación para permitir a los equipos autorrescatarse o una evacuación en caso de accidente</td>
						...
						<tr>
							...
							<td colspan="3">Qué es una cadena de seguridad?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Acceso en progresiones hacia arriba y hacia abajo y, por otro, nos mantiene seguros frente a las posibles caídas</td>
						...
						<tr>
							...
							<td colspan="4">El trabajo en altura se define como cualquier actividad o desplazamiento que realice un trabajador mientras esté expuesto a un riesgo de caída a distinto nivel</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="4">Un sistema anticaídas es un dispositivo de aseguramiento, independiente del modo de progresión o sujeción, conectado al punto de enganche “A” (anticaídas) del arnés</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La altura libre tiene en cuenta: La distancia de parada de los aparatos móviles o la longitud del elemento de amarre</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La energía potencial de un bombero en altura depende de su masa y de la altura de la caída</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Una  Cuerda de tracción será la cuerda que nos proporcione seguridad en caso de que falle algún elemento de la parte de tracción (SAS, mosquetones o la propia cuerda)</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los nudos tienen la misión de unir al bombero con la cuerda y la cuerda con los seguros</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los desviadores son una de las instalaciones más utilizadas en rescate urbano y trabajos verticales hasta el punto de que a veces incluso se utiliza el trípode como desviador</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso15.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
