	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso2.php">Seguridad vial</a></li>			  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/02 Seguridad Vial.pdf">aqu&iacute;</a>.</span>
			</div>
			
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<br/>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=CeYi3tdUtZE" target="_blank">Consejos de seguridad Vial.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=WRmUoSaDySc" target="_blank">Concientizaci&oacute;n Seguridad Vial.</a>				
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 2)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso2_prueba.php'><strong>Presentar prueba del curso</strong></a>
