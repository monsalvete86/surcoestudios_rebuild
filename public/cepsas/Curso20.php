	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso20.php">Actualización de normas de tránsito</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/20 actualizacion de normas de transito.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=pFwx1eGTaQM" target="_blank">Compilación de la Ley 769 de 2002, Código Nacional de Transito</a>
				    <br>
				    <a target="_blank" href=" https://www.youtube.com/watch?v=zm-30b3TIcw  " target="_blank">Señales de Tránsito Colombia</a>
				</div>
			...
			<div>
				...
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 20)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso20_prueba.php'><strong>Presentar prueba del curso</strong></a>
