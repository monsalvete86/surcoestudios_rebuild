...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 20</title>
		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 20 : ACTUALIZACIÓN DE NORMAS DE TRÁNSITO - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">Por qué un programa de Seguridad en la Flota de Vehículos?</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>Falta de acciones preventivas</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>Responsabilidad social empresarial</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="b"&&$r1!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td><td>Falta de conciencia en los conductores</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="c"&&$r1!="0"){ echo "checked"; }?> value="c"></td>
						</tr>
						<tr>
							<td><b>d.</b></td><td>Falta de conciencia en los conductores</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="d"&&$r1!="0"){ echo "checked"; }?> value="d"></td>
						</tr>
						
						<tr>
							<td rowspan="5"><b>2.</b></td>
							<td colspan="3">El diagnóstico inicial se encarga de:</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Revisión de políticas locales, Conformación del Comité de Seguridad Vial</td>
						...
						<tr>
							...
							<td colspan="4">Un factor crítico que afecta a la  tasa de  motorización es la multiplicación de las motocicletas</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="4">Una de las características del sector de la movilidad en América Latina  es la importancia de la oferta de transporte informal</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los resultados de la investigación indican que el 43% de los trabajadores conducen entre 1 y 9 horas al día</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">El enfoque sistémico dinámico tiene como objetivo identificar y corregir las principales fuentes de error o deficiencias de diseño y los comportamientos peligrosos que contribuyen a los accidentes de tránsito</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La Planificación programa de seguridad se encarga de actividades encaminadas a tener vehículos y personas más seguras en la operación</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Relevamiento de rutas Evaluación de Riesgos Viales Rutas Seguras cumple con   Programas encaminados a generar competencias específicas</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">El programa de capacitación establece parámetros de evaluación de conductores</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">CARGAS LÍQUIDAS, CARGAS SÓLIDAS Y/O SECAS SON: Influencias laterales, influencias longitudinales tipo de carga, influencia peso, etc</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso20.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
