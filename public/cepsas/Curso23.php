...
<html>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			<h1>
			  PRIMEROS AUXILIOS Y ERGONOMIA EN EL TRANSPORTE
			</h1>
			<ol class="breadcrumb">
			  <li><a href="index.html"><i class="fa fa-dashboard"></i>Home</a></li>
			  <li><a href="cursos.php">Cursos</a></li>						  
			  <li><a href="Curso23.php">Primeros Auxilios y Ergonomía en el Transporte</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/23 Curso Primeros Auxilios y Ergonomia en el transporte.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>

				<span><strong>Soporte normativo</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=sojGgs0Ye-8" target="_blank">ERGONOMIA 1</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=1I9tGvHx1Hg" target="_blank">ERGONOMIA 1</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=Xvw0rj2HwTM" target="_blank">ERGONOMIA DE LA CONDUCCION</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=6SbStNd4lAE" target="_blank">Ergonomía y posición correcta al volante</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 23)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso23_prueba.php'><strong>Presentar prueba del curso</strong></a>
