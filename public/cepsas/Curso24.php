...
<html>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			<h1>
			  RESCATE VERTICAL EN ALTURAS
			</h1>
			<ol class="breadcrumb">
			  <li><a href="index.html"><i class="fa fa-dashboard"></i>Home</a></li>
			  <li><a href="cursos.php">Cursos</a></li>						  
			  <li><a href="Curso24.php">Rescate vertical en alturas</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/24 rescate vertical en alturas.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>

				<span><strong>Soporte normativo</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.arlsura.com/files/res1409_2012.pdf" target="_blank">Resolucion  1409 de 2012</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=wv1TvyLPNvw" target="_blank">Rescate vertical en alturas</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=k6P3QwHxC7c" target="_blank">Socorro básico</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=pMMMRITk9oo" target="_blank">Rescate con descendedor</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 24)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso24_prueba.php'><strong>Presentar prueba del curso</strong></a>
