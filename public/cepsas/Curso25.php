...
<html>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			<h1>
			  ENTRENAMIENTO EN SISTEMAS DE COMANDO E INCIDENTES
			</h1>
			<ol class="breadcrumb">
			  <li><a href="index.html"><i class="fa fa-dashboard"></i>Home</a></li>
			  <li><a href="cursos.php">Cursos</a></li>						  
			  <li><a href="Curso9.php">Entrenamiento en Sistemas de Comando e Incidentes</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/25 Entrenamiento en Sistemas de Comando e Incidentes.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=BP2ZtfaIDOg" target="_blank">Consejos Prácticos</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 25)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso25_prueba.php'><strong>Presentar prueba del curso</strong></a>
