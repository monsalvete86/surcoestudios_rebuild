...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 25</title>
		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 25 : ENTRENAMIENTO EN SISTEMAS DE COMANDO E INCIDENTES - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">El Sistema de Comando de Incidentes (SCI) es?</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>La identificación del problema y la estimación de las posibles consecuencias determinan el grado de desarrollo del Sistema en la escena</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>La combinación de instalaciones, equipamiento, personal, protocolos, procedimientos y comunicaciones, operando en una estructura organizacional común</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="b"&&$r1!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td><td>Evento de probable aparición y desarrollo en adición a la situación presenteo</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="c"&&$r1!="0"){ echo "checked"; }?> value="c"></td>
						</tr>
						
						<tr>
							<td rowspan="5"><b>2.</b></td>
							<td colspan="3">Cuándo se a plica el SCI?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Se aplica a cualquier incidente, evento u operativo.</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="a"&&$r2!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td>
							<td>Incendios forestales, restauración de zonas quemadas</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="b"&&$r2!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td>
							<td>Programas para controlar o erradicar plagas y epidemias</td>
						...
						<tr>
							...
							<td colspan="4">El Comandante del Incidente (CI) es la persona a cargo, es quien posee la máxima autoridad del Sistema de Comando</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="4">La organización del SCI no tiene la capacidad de ampliarse o contraerse para adecuarse a las necesidades del incidenteo</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">El Curso SCI capacita en el uso de una herramienta útil para lograr eficiencia en el    comando, el control y la coordinación de las operaciones de respuesta a un incidente</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La unidad de situación Prepara el Plan de Acción del Incidente, mantiene toda la documentación relacionada con el incidente y provee servicios de duplicación</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">El Curso SCI capacita en el uso de una herramienta útil para lograr eficiencia en el comando.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La Unidad de Desmovilización en emergencias complejas y de gran magnitud, ayuda a efectuar la desmovilización del personal de manera ordenada y segura</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La Sección de Planificación incluyen recolectar, evaluar  y usar la información acerca del desarrollo del incidente y llevar un control de los recursos</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
