...
<html>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			<h1>
			  PRIMERA RESPUESTA DE INCIDENTES CON MATERIALES PELIGROSOS
			</h1>
			<ol class="breadcrumb">
			  <li><a href="index.html"><i class="fa fa-dashboard"></i>Home</a></li>
			  <li><a href="cursos.php">Cursos</a></li>						  
			  <li><a href="Curso26.php">Primera respuesta de incidentes con materiales peligrosos</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/26 Primera Respuesta de Incidentes con Materiales Peligrosos.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=JRN4dfwbd0I" target="_blank">Consejos prácticos</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 26)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso26_prueba.php'><strong>Presentar prueba del curso</strong></a>
