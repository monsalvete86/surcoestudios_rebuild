...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 26</title>
		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 26 : PRIMERA RESPUESTA DE INCIDENTES CON MATERIALES PELIGROSOS - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">Qué es la Primera respuesta de incidentes con materiales peligrosos?</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>Toda sustancia sólida, liquida, gaseosa, biológica que puede ocasionar daños a los seres humanos</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>Son aquellas sustancias que no perjudican la integridad  de los seres humanos</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="b"&&$r1!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td><td>Aquellas sustancias que se pueden almacenar  en cualquier contenedor y transportarlas en cualquier tipo de vehículo</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="c"&&$r1!="0"){ echo "checked"; }?> value="c"></td>
						</tr>
						
						<tr>
							<td rowspan="4"><b>2.</b></td>
							<td colspan="3">Qué es    NFPA  704?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Sustancia peligrosa que ocasiona daños al ser humano</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="a"&&$r2!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td>
							<td>sistema estandarizado para la identificación de riesgo de incendio de materiales peligrosos</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="b"&&$r2!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td>
							<td>Identificación de peligros para el hombre y medio Ambiente</td>
						...
						<tr>
							...
							<td colspan="4">Las personas que están   expuestas a materiales peligrosas pueden constituir un riesgo</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="4">El  NFPA 704 Provee información básica para bomberos, personal de emergencias</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Incidente por materiales peligrosos: evento no deseado que incluye la liberación o potencial liberación de materiales peligrosos en la que personas expuestas pueden morir</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">los productos peligrosos no pueden ser fácilmente reconocidos, a distancia, por las características del rótulo</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los sólidos inflamables reaccionan exotérmicamente con el agua y producen hidrógeno</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Agentes infecciosos son sustancias que contienen microorganismos y sus toxinas (como las bacterias, virus, parásitos, hongos), que pueden producir enfermedades en los animales y el hombre</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los oxidantes  son sustancias que sin ser combustibles, liberan oxígeno y facilitan la combustión de otras</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los materiales radioactivos son sustancias que no emiten radiaciones de cierta significación dañinas a organismos vivientes</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso26.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
