...
<html>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			<h1>
			  RESPUESTA Y ATENCION DE EMERGENCIAS CON MATERIALES PELIGROSOS
			</h1>
			<ol class="breadcrumb">
			  <li><a href="index.html"><i class="fa fa-dashboard"></i>Home</a></li>
			  <li><a href="cursos.php">Cursos</a></li>						  
			  <li><a href="Curso27.php">Respuesta y Atencion de Emergencias con Materiales Peligrosos - Nivel Avanzado</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/27 Curso RESPUESTA Y ATENCION DE EMERGENCIAS CON MATERIALES PELIGROSOS.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>

				<span><strong>Soporte normativo</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=kboPKK1LYus" target="_blank">Emergencias con Materiales Peligrosos 1</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=3YgFdAOl4jM" target="_blank">Etiquetas de mercancías peligrosas ADR</a>
					<br>
					<a target="_blank" href="https://www.youtube.com/watch?v=JRN4dfwbd0I" target="_blank">CAPACITACIÓN DE MATERIALES PELIGROSOS</a>
			...
			<div>
				...
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 27)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso27_prueba.php'><strong>Presentar prueba del curso</strong></a>
