...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 27</title>
		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 27 : RESPUESTA Y ATENCION DE EMERGENCIAS CON MATERIALES PELIGROSOS - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">Un plan de emergencias se divide en dos etapas principales:</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>Evacuación Y participación</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>Preparación Y Respuesta</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="b"&&$r1!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td><td>Señalización y rutas de escape </td>
						...
						<tr>
							...
							<td colspan="3">Cuál de las siguientes pertenece al Procedimientos de lucha contra emergencias:</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Evaluación</td>
						...
						<tr>
							...
							<td colspan="3">Cómo acción inmediata de precaución, aísle en todas direcciones, el área del derrame o escape como mínimo a:</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>50 metros</td>
						...
						<tr>
							...
							<td colspan="3">Las sustancias Tóxicas y sustancias infecciosas pertenecen a la clase :</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Clase 1</td>
						...
						<tr>
							...
							<td colspan="3">El análisis de riesgos tiene por objetivo identificar y evaluar cuales son aquellos eventos o condiciones que pueden llegar a ocasionar una emergencia</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Las sustancias no combustibles no encienden por sí mismas, pero se pueden descomponer al calentarse y producir vapores corrosivos y/o tóxicos.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La clase de riesgo de materiales peligrosos está indicada tanto por su número de clase (o división) o por nombre. Los carteles/placas se utilizan para identificar la clase o división del material </td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Para clorosilanos, no use agua, use espuma afff resistente al alcohol como medio de expansión.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Se puede fumar en  donde haya un derrame, siempre y cuando esté a más de 30 metros?</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">En caso de contacto con la sustancia, enjuagar inmediatamente la piel o los ojos con agua corriente por lo menos durante 20 minutos.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso27.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
