	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso28.php">Acondicionamiento de andamios para trabajo en alturas</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/28 Acondicionamiento De Andamios Para Trabajo  En Alturas.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=jm2uQp1g3Z4" target="_blank">Consejos prácticos</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 28)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso28_prueba.php'><strong>Presentar prueba del curso</strong></a>
