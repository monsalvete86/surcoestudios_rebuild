...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 28</title>
		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 28 : ACONDICIONAMIENTO DE ANDAMIOS PARA TRABAJO EN ALTURAS - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">La planificación de la Seguridad Antes del Montaje está dirigida a:</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>Operarios</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>Los terceros, La Propia Estructura, Los Montadores</td>
						...
						<tr>
							...
							<td colspan="3">El número ideal de operarios para un montaje son?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>2</td>
						...
						<tr>
							<td><b>d.</b></td>
							<td>Ninguna de los anteriores</td>
						...
						<tr>
							...
							<td colspan="4">Los terceros Impiden la circulación peatonal en la fase de acopio de material y montaje</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="4">Plan de Montaje, Utilización y Desmontaje: Se refiere a aquellos andamios que tengan más de 6 m de altura o estén situados en un desnivel de 24 m</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">El Plan de Utilización consta de: Resumen de los aspectos más importantes que debe cuidar el usuario del andamio y que el responsable de la obra debe hacer respetar</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">El andamio multidireccional Brío tiene la característica de contar con elementos estructurales independientes de las plataformas</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Después de un montaje comienza la utilización del andamio</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los andamios deberán ser inspeccionados por una persona competente, con una formación universitaria o profesional</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Se monta el andamio después de comenzar las tareas de encofrado horizontal de la primera planta</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Cubriciones son  una aplicación que se realiza antes de iniciar la obra, con el objeto de proteger ante las inclemencias climáticas</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso28.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
