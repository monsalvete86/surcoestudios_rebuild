		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px" >
					<thead>
						<th colspan="4" style="text-align:center"><b>Curso 29 : ERGONOMIA - Prueba de conocimientos</b></th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">Que es la ergonomía?</td>
						</tr>
						<tr>
							<td><b>a.</b></td><td>Es adaptar el trabajo a las capacidades y posibilidades del ser humano</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="a"&&$r1!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td><td>La postura frente al computador</td>
							<td><input type="radio" name="res1[]" <?php if($r1=="b"&&$r1!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td><td>La correcta iluminación en el área de trabajo</td>
						...
						<tr>
							...
							<td colspan="3">Que es psicosociología aplicada?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Las necesidades de las personas  cambiantes, como lo es la propia organización social y política</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="a"&&$r2!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td>
							<td>La aplicación de conocimientos en las áreas sociales</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="b"&&$r2!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td>
							<td>El desarrollo de procedimiento para mejorar la productividad de un individuo</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="c"&&$r2!="0"){ echo "checked"; }?> value="c"></td>
						</tr>
						<tr>
							<td><b>d.</b></td>
							<td>La aplicación del reglamento de trabajo interno</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="d"&&$r2!="0"){ echo "checked"; }?> value="d"></td>
						</tr>
						
						<tr>
							<td rowspan="5"><b>3.</b></td>
							<td colspan="3">Las clases de ergonomía se puede clasificar en?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Ergonomía de puestos / ergonomía de sistemas</td>
							<td><input type="radio" name="res3[]" <?php if($r3=="a"&&$r3!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td>
							<td>Ergonomía de concepción o ergonomía de corrección</td>
							<td><input type="radio" name="res3[]" <?php if($r3=="b"&&$r3!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td>
							<td>Ergonomía geométrica</td>
						...
						<tr>
							...
							<td colspan="3">Las Principales Funciones del Departamento de Seguridad e Higiene?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Revisar y aprobar las políticas de seguridad</td>
							<td><input type="radio" name="res4[]" <?php if($r4=="a"&&$r4!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td>
							<td>Realizar inspecciones periódicas de seguridad. disposiciones legales</td>
							<td><input type="radio" name="res4[]" <?php if($r4=="b"&&$r4!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td>
							<td>Establecer normas adecuadas de seguridad, deben concordar con las</td>
						...
						<tr>
							...
							<td colspan="3">Unos de los principales objetivos de la ergonomía es Identificar, analizar y reducir los riesgos laborales (ergonómicos y psicosociales)</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La Ergonomía Ambiental es la rama de la Ergonomía, especializada en el estudio de los factores ambientales, generalmente físicos, que constituyen el entorno del sistema formado por la persona y el equipo de trabajo y su influencia en los aspectos relacionados con la seguridad, la eficiencia y la confortabilidad</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Ergonomía temporal: se encarga del estudio del bienestar del trabajador en relación con los tiempos de trabajo (los horarios de trabajo, los turnos, la duración de la jornada, el tiempo de reposo, las pausas y los descansos durante la jornada de trabajo, los ritmos de trabajo</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La persona en el trabajo se compromete en una triple relación. relación con la producción, una relación consigo mismo, una relación afectiva</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Cuando una persona esta estresada . Nuestro cerebro segrega unas sustancias, que se llaman Betaendorfinas</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los tipos de Cooperación son. cooperación cercana, cooperación organizada, y cooperación individual</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso12.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
