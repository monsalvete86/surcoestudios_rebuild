	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso3.php">Mec&aacute;nica b&aacute;sica</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/03 Mecanica Basica.pdf">aqu&iacute;</a>.</span>
			</div>
			
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<br/>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=UX_GyiwtwAQ" target="_blank">Revisi&oacute;n de Puntos b&aacute;sicos.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=c60z_WZjXtc" target="_blank">Consejos pr&aacute;cticos sobre el embrague.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=7irOGrDcUCM" target="_blank">La suspensi&oacute;n.</a>
				</div>			
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 3)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso3_prueba.php'><strong>Presentar prueba del curso</strong></a>
