...
<html>
	<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
		...
		<title>C.E.P.S.A.S. | Curso 31</title>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso22.php">Office - Excel</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/31 Curso Excel.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=yKWFMgurUnU" target="_blank">Introducción para principiantes</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=47nJsZ97sz0" target="_blank">Formulas y Autorellenos</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=BER2KhixV0Y" target="_blank">Gráficos</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=qnwmYg7nLZo" target="_blank">Funciones Básicas</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=_2Mg5vBSM4U" target="_blank">Formato Condicional</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=I0kYLaPNgRo" target="_blank">Validación de Datos</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=AIipB0FFw7Y" target="_blank">Filtros y Tablas dinámicas</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=B1vfwuQdqGo&list=PLLniqWgyb4HER2iysxcQZiE-TBITT1AAg&index=8" target="_blank">Funciones Sumar.Si y Promedio.Si</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=Wi86aPrar1Y" target="_blank">Enumerar Paginas en "pie de página"</a>
			...
			<div>
				...
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 31)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso31_prueba.php'><strong>Presentar prueba del curso</strong></a>
