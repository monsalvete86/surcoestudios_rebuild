	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso22.php">Office - Power Point</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/32 Curso Power Point.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=pDfZOFtdF-A" target="_blank">Introducción para principiantes</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=zSlphB32lVU" target="_blank">Creando Diapositiva Sencilla</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=OVBpCNYyD5c" target="_blank">Álbum de Fotos e Hipervínculos</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=PEyp3k8TM4s" target="_blank">Insertar Videos online y offline</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=dYYFOifmcSo" target="_blank">Creando Animaciones</a>
				    <br>
				    <a target="_blank" href="https://www.youtube.com/watch?v=802Ozxa9vRc" target="_blank">Gráficos de Excel en PowerPoint</a>
			...
			<div>
				...
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 32)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso32_prueba.php'><strong>Presentar prueba del curso</strong></a>
