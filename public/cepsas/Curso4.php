...
<html>
	<head>
		...
		<title>C.E.P.S.A.S. | Curso 4</title>
	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			<h1>
			  MANEJO DE EXTINTORES Y CONTRAINCENDIOS
			</h1>
			<ol class="breadcrumb">
			  <li><a href="index.html"><i class="fa fa-dashboard"></i>Home</a></li>
			  <li><a href="cursos.php">Cursos</a></li>						  
			  <li><a href="Curso4.php">Manejo de extintores y contraincendios</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/04 Manejo de extintores y contraincendios.pdf">aqu&iacute;</a>.</span>
			</div>			
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">									
					<a target="_blank" href="https://www.youtube.com/watch?v=YdQndqfwX0c" target="_blank">Uso de extintores.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=uyO8VhU7cvY" target="_blank">Consejos para usar el extintor en  veh&iacute;culos automotores.</a>
					<br/>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 4)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso4_prueba.php'><strong>Presentar prueba del curso</strong></a>
