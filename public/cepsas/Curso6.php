	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso6.php">Manejo de almacenamiento de sustancias peligrosas</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/06 Manejo y Almacenamiento de Sustancias Peligrosas.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
				<a target="_blank" href="https://www.youtube.com/watch?v=kVIp_Z-oaN8" target="_blank">Operaci&oacute;n con sustancias peligrosas.</a>
				<br/>
				<a target="_blank" href="https://www.youtube.com/watch?v=SpVxOnUuiG8" target="_blank">Transporte y manejo de sustancias.</a>				
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 6)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso6_prueba.php'><strong>Presentar prueba del curso</strong></a>
