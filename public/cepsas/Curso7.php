	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso7.php">Alistamiento vehicular</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/07 Alistamiento Vehicular.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=LgvqzVGcnKc" target="_blank">Alistamiento de un veh&iacute;culo.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=9bMKpF0eZyI" target="_blank">Alistamiento de camiones.</a>				
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 7)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso7_prueba.php'><strong>Presentar prueba del curso</strong></a>
