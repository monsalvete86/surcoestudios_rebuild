	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso8.php">Control de derrames</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/08 Control de derrames.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=orNKz_-Unr8" target="_blank">Control derrames.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=NHrY08KE_EQ" target="_blank">Contenci&oacute;n y manejo de derrames.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=orNKz_-Unr8" target="_blank">Kit control anti derrames.</a>					
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 8)
					{
						$MsjResult="Aprob&oacute;";
					if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso8_prueba.php'><strong>Presentar prueba del curso</strong></a>
