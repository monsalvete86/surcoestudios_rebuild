...
<html>
	<head>
		...
		<title>C.E.P.S.A.S. | Curso 8</title>
		...
		<div>
			<form action="" method="POST">
				<table border='1' style="width:800px">
					<thead>
						<th colspan="4" style="text-align:center">Curso 8 : CONTROL DE DERRAMES - Prueba de conocimientos</th>
					</thead>
					...
					<tbody>
						...
						<tr>
							...
							<td colspan="3">Los accidentes por el uso de sustancias, ocurren principalmente debido a</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>Desconocimiento de la peligrosidad</td>
						...
						<tr>
							...
							<td colspan="3">&#191;Uno de los factores m&aacute;s frecuentes y que contribuyen en los accidentes es?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>la deficiencia o carencia de identificaci&oacute;n en los envases o contenedores de los productos</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="a"&&$r2!="0"){ echo "checked"; }?> value="a"></td>
						</tr>
						<tr>
							<td><b>b.</b></td>
							<td>El cansancio del operario</td>
							<td><input type="radio" name="res2[]" <?php if($r2=="b"&&$r2!="0"){ echo "checked"; }?> value="b"></td>
						</tr>
						<tr>
							<td><b>c.</b></td>
							<td>La poca visibilidad</td>
						...
						<tr>
							...
							<td colspan="3">&#191;C&oacute;mo parte del plan de prevenci&oacute;n se debe contar con personal?</td>
						</tr>
						<tr>
							<td><b>a.</b></td>
							<td>En cantidad</td>
						...
						<tr>
							...
							<td colspan="3">Es necesario que las personas que manejan productos qu&iacute;micos, conozcan a fondo la informaci&oacute;n que contiene una hoja de seguridad o MSDS y la puedan interpretar en caso de emergencia.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Recoger el derrame puede implicar transvasar el contenido a un recipiente seguro.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Una vez recogido, el producto se debe incinerar de inmediato.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">Los niveles de protecci&oacute;n se clasifican en nivel X,Y,Z2.</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr>
							...
							<td colspan="3">La liberaci&oacute;n al ambiente de elementos y/o sustancias de manejo restringido, 
							que pueden representar un peligro para la poblaci&oacute;n y/o medio ambiente, &#191;se llama derrame?</td>
						</tr>
						<tr>
							<td colspan="2">F</td>
						...
						<tr align="center">
							<td colspan="4">
								...
								<a href="Curso8.php" class="btn btn-default">Regresar</a>
							</td>
						</tr>
					</tbody>
				</table>
