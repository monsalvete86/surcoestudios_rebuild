	...
	<!-- contenido a copiar para generar la cabecera -->
		...
		<section class="content-header">
			...
			<ol class="breadcrumb">
			  ...
			  <li><a href="Curso9.php">Atenci&oacute;n al cliente</a></li>						  
			</ol>
		</section><br>
		<div style="position:absolute;left:30px">
			<div>
				<span>Descargar contenido del curso <a target="_blank" href="pdf/09 Atencion al cliente.pdf">aqu&iacute;</a>.</span>
			</div>
			<div>
				<span><strong>Material de apoyo Audiovisual:</strong></span>
				<div style="left: 61px; position: relative">
					<a target="_blank" href="https://www.youtube.com/watch?v=ejD34cB36aQ" target="_blank">Protocolo de servicio al cliente.</a>
					<br/>
					<a target="_blank" href="https://www.youtube.com/watch?v=SpVxOnUuiG8" target="_blank">La excelencia en el servicio al cliente.</a>
				</div>
			<div>
				<?php
				if(isset($_SESSION['alumno']))
				{
					if($consulta2['curso'] == 9)
					{
						$MsjResult="Aprob&oacute;";
						if($consulta2['resultado']<60){$MsjResult="No aprob&oacute";}
						echo "<a href='Curso9_prueba.php'><strong>Presentar prueba del curso</strong></a>
