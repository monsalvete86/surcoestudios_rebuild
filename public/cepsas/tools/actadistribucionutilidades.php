...
$datospregunta = datospregunta($pregunta);
...
$pdf->Ln(5);
$añoanterior = $año - 1;
$txt = 'ACTA DE CIERRE DE ESCRITINIO DISTRIBUCIÓN DE UTILIDADES';  
$pdf->Cell(195,5,iconv('UTF-8', 'ISO-8859-2', $txt),0,0,'C');	
$pdf->Ln(10);
$pdf->SetFont('Arial','',10);
$txt = 'En las instalaciones del Auditorio Centenario de COMFAMILIAR del  Municipio de Puerto Asís, siendo las '.$hora.':'.$minuto.' del día '.$dia.' de '.$mes.' de '.$año.', certificamos los resultados del escrutinio efectuado.';  
$pdf->MultiCell(0,5,iconv('UTF-8','',$txt));		
$pdf->Ln(20);
$pdf->SetFont('Arial','',8);
$pdf->Cell(93,5,'ACTA DE CIERRE DE PROPUESTAS VARIAS.',0,0,'L');
$pdf->Cell(97,5,'',0,0,'C');
$pdf->Ln(5);
$pdf->SetFont('Arial','B',8);
$txt = "PROPOSICIÓN DISTRIBUCIÓN DE UTILIDADES:  ".$datospregunta['pregunta'];
$pdf->Cell(93,5,iconv('UTF-8', 'ISO-8859-2', $txt),1,0,'L');
$pdf->Cell(97,5,'TOTAL VOTOS',1,0,'C');
$pdf->Ln(5);
if($pregunta_items=pregunta_items($pregunta))
{
	$acciones_votantes =0;
	while($datos2= mysql_fetch_array($pregunta_items))
	{
		...
		if($respuestas > 0)
		{			
			$pdf->Cell(93,5,iconv('UTF-8', 'ISO-8859-2', $datos2['item']),1,0,'L');
			$pdf->Cell(97,5,$respuestas,1,0,'C');
...
$pdf->Ln(5);
$pdf->Cell(93,5,iconv('UTF-8', 'ISO-8859-2','TOTAL VOTACIÓN'),1,0,'L');
$pdf->Cell(97,5,$acciones_votantes,1,0,'C');
$pdf->Ln(10);
$txt = 'EN CONSTANCIA DE LO ANTERIOR, FIRMAMOS EL DÍA '.$dia.' DE '.$mes.' DE '.$año.' LA COMISIÓN ESCRUTADORA DESIGNADA POR LA ASAMBLEA GENERAL DE ACCIONISTAS:';
$pdf->MultiCell(0,5,iconv('UTF-8','',$txt));
$pdf->Ln(25);
$pdf->SetFont('Arial','',10);
$pdf->Cell(65,5,'',0,0,'L');
...
$pdf->Cell(65,5,'','T',0,'L');
$pdf->Ln(5);
$pdf->Cell(65,5,'VOBO. REVISOR FISCAL EEBP SA ESP',0,0,'L');
$pdf->Cell(65,5,'',0,0,'L');
...
$pdf->Cell(65,5,'',0,0,'L');
$pdf->Cell(65,5,iconv('UTF-8', 'ISO-8859-2','COMISIÓN ESCRUTADORA'),0,0,'L');
echo $pdf->Output("Acta_distribucion_utilidades_".$añoanterior.".pdf",'D');
?>
?>