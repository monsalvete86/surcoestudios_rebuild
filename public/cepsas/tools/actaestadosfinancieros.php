...
$pdf->Ln(5);
$añoanterior = $año - 1;
$txt = 'ACTA DE CIERRE DE ESCRUTINIO APROBACIÓN DE ESTADOS FINANCIEROS A 31 DE DICIEMBRE DE '.$añoanterior;  
$pdf->Cell(195,5,iconv('UTF-8', 'ISO-8859-2', $txt),0,0,'C');	
$pdf->Ln(10);
$pdf->SetFont('Arial','',10);
$txt = 'En las instalaciones del Auditorio Centenario de Comfamiliar, siendo las '.$hora.':'.$minuto.' del día '.$dia.' de '.$mes.' de '.$año.', certificamos los resultados del escrutinio efectuado para la APROBACIÓN ESTADOS FINANCIEROS A 31 DE DICIEMBRE DE '.$añoanterior;  
...
$pdf->Cell(65,5,'',0,0,'L');
$pdf->Cell(65,5,iconv('UTF-8', 'ISO-8859-2','COMISIÓN ESCRUTADORA'),0,0,'L');
echo $pdf->Output("Acta_aprovacion_estados_financieros_".$añoanterior.".pdf",'D');
?>
