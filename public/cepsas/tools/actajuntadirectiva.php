...
$pdf->Ln(5);
$segundoaño = $año + 1;
$txt = 'ACTA DE CIERRE DE ESCRUTINIO ELECCIÓN JUNTA DIRECTIVA '.$año.'-'.$segundoaño;  
$pdf->Cell(195,5,iconv('UTF-8', 'ISO-8859-2', $txt),0,0,'C');	
$pdf->Ln(10);
$pdf->SetFont('Arial','',10);
$txt = 'En las instalaciones del Auditorio Centenario del Centro Recreacional COMFAMILIAR del Municipio de Puerto Asís, siendo las '.$hora.':'.$minuto.' del día '.$dia.' de '.$mes.' de '.$año.', certificamos los resultados del escrutinio efectuado para la ELECCIÓN DE LA JUNTA DIRECTIVA '.$año.'-'.$segundoaño;  
$pdf->MultiCell(0,5,iconv('UTF-8','',$txt));		
$pdf->Ln(20);
$pdf->SetFont('Arial','B',8);
$pdf->Cell(20,5,'PLANCHAS',1,0,'C');
$pdf->Cell(107,5,'NOMBRES Y APELLIDOS',1,0,'C');
$pdf->Cell(63,5,iconv('UTF-8', 'ISO-8859-2', 'VOTACIÓN'),1,0,'C');
$pdf->Ln(5);
$cont = 1;
if($pregunta_items=pregunta_items($pregunta))
{
	...
	while($datos2= mysql_fetch_array($pregunta_items))
	{
		...
		{			
			...
			$pdf->Cell(107,5,iconv('UTF-8', 'ISO-8859-2', $datos2['item']),1,0,'L');
			$pdf->Cell(63,5,$respuestas,1,0,'C');
...
$pdf->Ln(5);
$pdf->Cell(127,5,iconv('UTF-8', 'ISO-8859-2','TOTAL VOTACIÓN'),1,0,'L');
$pdf->Cell(63,5,$acciones_votantes,1,0,'C');
$pdf->Ln(10);
