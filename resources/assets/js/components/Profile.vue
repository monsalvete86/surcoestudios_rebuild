            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header p-2">
                        ...
                        <li class="nav-item"><h2>Datos</h2></li>
                        </ul>
                    </div><!-- /.card-header -->
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active show" id="settings">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                    <textarea  v-model="form.bio" class="form-control" id="inputExperience" placeholder="Experiencia" :class="{ 'is-invalid': form.errors.has('bio') }"></textarea>
                                ...
                                <div class="form-group">
                                    <label for="password" class="col-sm-12 control-label">Clave (Dejar en blanco si no desea cambiarla)</label>
