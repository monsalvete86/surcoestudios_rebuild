...
<html lang="<?php echo e(app()->getLocale()); ?>">
    <head>
      ...
      <title>Surcoestudios</title>
        ...
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/jquery-ui.css">
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/owl.carousel.min.css">
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/owl.theme.default.min.css">
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/owl.theme.default.min.css">
    
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/jquery.fancybox.min.css">
    
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/bootstrap-datepicker.css">
    
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/fonts/flaticon/font/flaticon.css">
    
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/aos.css">
        <link href="<?php echo e(env('APP_URL')); ?>/css/jquery.mb.YTPlayer.min.css" media="all" rel="stylesheet" type="text/css">
    
        <link rel="stylesheet" href="<?php echo e(env('APP_URL')); ?>/css/style.css">
    </head>
            ...
            <div class="row align-items-center">
              ...
              <?php else: ?>
                <div class="col-xl-4 text-right">
                  ...
                  <a href="<?php echo e(env('APP_URL')); ?>/logout"           class="btn btn-outline-danger small ml-3 px-4 py-2 rounded-0 " onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
              ...
              <div class="mr-auto">
                <nav class="site-navigation position-relative text-right" role="navigation">
                  <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                    ...
                    <li>
                      <a href="<?php echo e(env('APP_URL')); ?>/oferta" class="nav-link text-left">Cursos</a>
                    </li>  
                    <li>
                      <a href="<?php echo e(env('APP_URL')); ?>/diplomados" class="nav-link text-left">Diplomados</a>
                    </li>                  
                    <li>
