                    ...
                    <div class="course-1-item">
                        <figure class="thumnail">
                          <a href="/detalle/<?php echo e($curso->id); ?>">
                            <img src="<?php echo e(env('APP_URL')); ?>/img/cursos/<?php echo e($curso->img ? $curso->img : 'course_2.jpg'); ?>" alt="Image" class="img-fluid">
                          </a>
                         
                          <div class="category" style="background: #d86a0b; color: white;"> Curso en <h3><?php echo e($curso->nombre); ?></h3></div>  
                        </figure>
                        ...
                        <p class="desc mb-4">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Similique accusantium ipsam.</p>-->
                          ...
                          <p><a href="<?php echo e(env('APP_URL')); ?>/detalle/<?php echo e($curso->id); ?> " class="btn btn-primary rounded-0 px-4">Ver más</a></p>
