    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('../img/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <h2 class="mb-0"><?php echo e($curso->nombre); ?></h2>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 mb-4">
                    <p>
                        <img src="/img/cursos/<?php echo e($curso->img ? $curso->img : 'course_2.jpg'); ?>" alt="Image" class="img-fluid">
                    </p>
                </div>
                <div class="col-lg-5 ml-auto align-self-center">
                    <?php if($curso->tipo == 1): ?>
                        ...
                        <p><strong class="text-black d-block">Instructor:</strong> <?php echo e(isset($tutores[$curso->tutor])? $tutores[$curso->tutor] : "Rodolfo Silva"); ?></p>
                        <p><strong class="text-black d-block">Duración:</strong> <?php echo e($curso->duracion); ?>
                            ...
                            <?php else: ?> Meses
                            <?php endif; ?></p>
                        <p><strong class="text-black d-block">Categoría:</strong> <?php echo e($categorias[$curso->categoria]); ?></p>
                        ...
                        <p>
                          ...
                          <?php else: ?>
                            <p><a onClick="if(!confirm('Esta seguro de inscribirte a este curso?')){reu" href="<?php echo e(env('APP_URL')); ?>/inscribirme/<?php echo e($curso->id); ?>" class="btn btn-primary rounded-0 px-4">Inscribirse</a></p>
